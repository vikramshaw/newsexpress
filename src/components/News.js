...
export class News extends Component {
  ...
  async componentDidMount(){
    // console.log("cdm");
    let url = `https://newsapi.org/v2/top-headlines?country=in&apikey=9830904d976041d0989bf715702fc86e&page=1&pageSize=${this.props.pageSize}`;
  ...
  handlePrevClick= async ()=> {
    console.log("prev");
    let url = `https://newsapi.org/v2/top-headlines?country=in&apikey=9830904d976041d0989bf715702fc86e&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
    this.setState({loading: true});
    let data = await fetch(url);
    let parsedData = await data.json()
